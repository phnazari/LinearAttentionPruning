...
class DeltaNet2Config(PretrainedConfig):

    model_type = 'delta_net_2'
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if conv_scaled_shift is not None and shift_only_conv is False:
            raise ValueError(
                "`conv_scaled_shift` can only be set when `shift_only_conv` is True.",
            )
