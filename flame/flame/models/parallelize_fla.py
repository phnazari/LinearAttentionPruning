...
def parallelize_fla(
    ...
    Args:
        defer_compile: If True, skip torch.compile (to be applied after checkpoint loading)
    """
    ...
    # Skip if defer_compile is True (will be applied after checkpoint loading)
    #if job_config.training.compile and not defer_compile:
    #    apply_compile(model)
